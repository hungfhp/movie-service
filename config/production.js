...
module.exports = {
  ...
  mongoHost: "gr-qduyu.gcp.mongodb.net",
  mongoPort: '',
  mongoUser: 'hung',
  mongoPassword: "1",
  mongoURL: process.env.MONGOLAB_URL || 'mongodb+srv://hung:1@gr-qduyu.gcp.mongodb.net/test?retryWrites=true',
  logMongoURL: process.env.LOG_MONGOLAB_URL || 'mongodb://localhost:27017/snipelogs',
  ...
  redisURL: process.env.REDIS_URL || 'redis://:1@redis-14718.c10.us-east-1-4.ec2.cloud.redislabs.com:14718/0',
